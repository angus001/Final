title: "R AssignmentWeek4"

author: Angus (Group --"Nabila","sanjive","Angus")

date: "July 25, 2015"

output: html_document
RPubs Link 
http://rpubs.com/ahuang/96149
...
.scatterplot Do the graphics provide insight into any relationships in the data?
...
Conclusion: Plotting the scatter chart for each of the state, we concluded that lower education has high impact on individual's economic state with few exception as outliers which we have funneled in our BoxPlot.
